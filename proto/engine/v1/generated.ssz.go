...
// Hash: 8490e4862e0f230e16c0a15b4c8f98b10b33d96abd85f231a1c0f1779dc6e6e9
package enginev1
...
func (b *Blob) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Blob'
	if size := len(b.Blob); size != 4096 {
		err = ssz.ErrVectorLengthFn("--.Blob", size, 4096)
		return
	}
	for ii := 0; ii < 4096; ii++ {
		if size := len(b.Blob[ii]); size != 32 {
			err = ssz.ErrBytesLengthFn("--.Blob[ii]", size, 32)
			return
		}
