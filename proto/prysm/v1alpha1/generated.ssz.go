...
// Hash: fc51f71f1fe925c94b21cec82a32dc81a8a5930e0835dc2bf52dbabead60a74e
package eth
...
func (b *BeaconBlockBodyWithBlobKZGs) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (10) 'BlobKzgs'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(16, numItems, 0))
		} else {
